...
public class StadiumFacadeImpl implements StadiumFacade
{
	...
	/*
	 * @Override public List<StadiumDataTO> getAllStadium() { final List<StadiumDataTO> dataTOs = new
	 * ArrayList<StadiumDataTO>(); dataTOs.add(new StadiumDataTO("Wembley", Integer.valueOf(12345))); return dataTOs; }
	 */
